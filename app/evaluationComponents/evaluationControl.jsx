...
const stylesEC = StyleSheet.create({
  ...
  bottomLocal: {
    position: 'absolute', // Fixiert die Position
    bottom: 0, // Am unteren Rand der übergeordneten View
    width: '100%', // Br
  },
});
