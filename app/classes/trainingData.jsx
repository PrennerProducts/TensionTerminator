...
class TrainingData {
  constructor(ID, whatIsHurtingBefore, howItIsHurtingBefore, howMuchIsItHurtingBefore, evaluationAngleLeftBefore,
    evaluationAngleRightBefore, trainingRight, trainingWrong, trainingTime, evaluationAngleLeftAfter, evaluationAngleRightAfter,
  ...
  async load() {
    ...
    return new TrainingData(JSON.parse(myObj).ID, JSON.parse(myObj).whatIsHurtingBefore, JSON.parse(myObj).howItIsHurtingBefore, JSON.parse(myObj).howMuchIsItHurtingBefore, JSON.parse(myObj).evaluationAngleLeftBefore,
    JSON.parse(myObj).evaluationAngleRightBefore, JSON.parse(myObj).trainingRight, JSON.parse(myObj).trainingWrong, JSON.parse(myObj).trainingTime, JSON.parse(myObj).evaluationAngleLeftAfter, JSON.parse(myObj).evaluationAngleRightAfter, JSON.parse(myObj).howMuchIsItHurtingAfter);
  }
}
